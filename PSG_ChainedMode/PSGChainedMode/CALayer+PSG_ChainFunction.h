...
- (CALayer *(^)(CGFloat))g_contentsScale CA_AVAILABLE_STARTING (10.7, 4.0, 9.0, 2.0);
- (CALayer *(^)(CGRect))g_contentsCenter;
- (CALayer *(^)(NSString *))g_contentsFormat CA_AVAILABLE_STARTING (10.12, 10.0, 10.0, 3.0);
...
- (CALayer *(^)(BOOL))g_drawsAsynchronously CA_AVAILABLE_STARTING (10.8, 6.0, 9.0, 2.0);
...
- (CALayer *(^)(CACornerMask))g_maskedCorners CA_AVAILABLE_STARTING (10.13, 11.0, 11.0, 4.0);
